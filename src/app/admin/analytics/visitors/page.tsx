...
export default async function AdminAnalyticsVisitorsPage({ searchParams }: AdminAnalyticsVisitorsPageProps) {
  ...
  return (
    <div className="mx-auto max-w-7xl">
      ...
      <form action="/admin/analytics/visitors" className="mb-6 grid gap-3 rounded-lg border border-neutral-200 bg-white p-4 text-sm dark:border-neutral-800 dark:bg-neutral-950 sm:grid-cols-[repeat(3,minmax(0,1fr))_auto]">
        ...
        <div className="flex items-end"><button className="rounded-md bg-neutral-950 px-4 py-2 text-sm font-medium text-white dark:bg-neutral-100 dark:text-neutral-950">应用</button></div>
      </form>
